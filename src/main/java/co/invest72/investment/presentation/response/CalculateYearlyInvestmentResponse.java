...
public class CalculateYearlyInvestmentResponse {
	...
	@Builder
	public CalculateYearlyInvestmentResponse(int totalInvestment, int totalPrincipal, int totalInterest,
	...
	public String toString() {
		...
		String body = details.stream()
			.map(result -> String.format("%-10d %-15d %-15d %-15d%n",
				result.getYear(), result.getPrincipal(), result.getInterest(), result.getProfit()))
