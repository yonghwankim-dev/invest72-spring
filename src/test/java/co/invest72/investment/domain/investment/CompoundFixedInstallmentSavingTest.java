...
class CompoundFixedInstallmentSavingTest {
	...
	void getPrincipalForYear() {
		...
		assertEquals(BigDecimal.valueOf(24_330_017), investment.getPrincipalForYearMoney(2).getValue());
		assertEquals(BigDecimal.valueOf(37_290_862), investment.getPrincipalForYearMoney(3).getValue());
		assertEquals(BigDecimal.valueOf(37_290_862), investment.getPrincipalForYearMoney(4).getValue());
	}
	...
	void getPrincipalForYear_whenPeriodIs25Months() {
		...
		assertEquals(BigDecimal.valueOf(12_000_000), investment.getPrincipalForYearMoney(1).getValue());
		assertEquals(BigDecimal.valueOf(24_330_017), investment.getPrincipalForYearMoney(2).getValue());
		assertEquals(BigDecimal.valueOf(26_290_862), investment.getPrincipalForYearMoney(3).getValue());
		assertEquals(BigDecimal.valueOf(26_290_862), investment.getPrincipalForYearMoney(4).getValue());
	}
